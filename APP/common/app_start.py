...
class StartApp(object):
    ...
    def preparework(self):
        ...
        while True:
            try:
                driver = webdriver.Remote("http://127.0.0.1:" + str(self.port + 2 * self.deviceindex) + "/wd/hub",desired_caps)
    ...
    def appium_server(self):
        ...
        print(cmd)
        subprocess.Popen(cmd, shell=True, stdout=open(reportdir + str(self.port) + ".log", "w"),
    ...
    def logout(self):
        ...
        time.sleep(4)
    @classmethod
    def final_start_app(cls,host, port):
        """在此设置测试顺序"""
        I = StartApp(host, port,)
        print(22222222)
        I.check_client()
        print(444444)
        I.appium_server()
        print(555555555555555555)
        driver = I.preparework()
        return driver
    # @classmethod
...
if __name__ == '__main__':
    host = "127.0.0.1"
    port = 4723
    f = StartApp.final_start_app(host, port)